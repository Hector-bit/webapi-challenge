...
Answer: Express is a module that helps write web apps with Json and it also can be used to write API's

- [x] Describe Middleware?

Answer: Middleware are resources and it can also be functions.

- [x] Describe a Resource?

Answer: A resource is almost everything in the application that you can use.

- [x] What can the API return to help clients know if a request was successful?

Answer: You can return status codes along with more specific messages.

- [x] How can we partition our application into sub-applications?

Answer: You can use sub-routes by creating them in other files and then importing them all into the main file.
